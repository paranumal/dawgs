...
writeLatexFigure('V100_AR_N3_GA.tex', X, Y, Title, XTitle, YTitle, Legend);
%writeLatexFigure('MI100_AR_N3.tex', X, Y, Title, XTitle, YTitle, Legend);
...
XTitle = "Degrees of freedom per rank";
YTitle = "Throughput (DoFs per rank second)";
writeLatexFigure('V100_PW_N3_GA.tex', X, Y, Title, XTitle, YTitle, Legend);
%writeLatexFigure('MI100_PW_N3.tex', X, Y, Title, XTitle, YTitle, Legend);
...
XTitle = "Degrees of freedom per rank";
YTitle = "Throughput (DoFs per rank second)";
writeLatexFigure('V100_CR_N3_GA.tex', X, Y, Title, XTitle, YTitle, Legend);
%writeLatexFigure('MI100_CR_N3.tex', X, Y, Title, XTitle, YTitle, Legend);
